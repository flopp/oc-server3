 ...
 ****************************************************************************/
 ...
 $type_not_ok_message = '&nbsp;<span class="errormsg">' . t('No cache type has been chosen.') . '</span>';
 $size_not_ok_message = '&nbsp;<span class="errormsg">' . t('No cache size has been chosen.') . '</span>';
 $diff_not_ok_message = '&nbsp;<span class="errormsg">' . t('No difficulty/terrain rating has been chosen.') . '</span>';
 $sizemismatch_message = '&nbsp;<span class="errormsg">' . t('For virtual and webcam caches, the cache size has to be -no container-!') . '</span>';
 $gcwpt_not_ok_message = '<tr><td></td><td><span class="errormsg">' . t('The geocaching.com waypoint is invalid; valid format: GC12345') . '</span></td></tr>';
 $ncwpt_not_ok_message = '<tr><td></td><td><span class="errormsg">' . t('The navicache.com waypoint is invalid; valid format: N12345') . '</span></td></tr>';
 $short_desc_empty_message = '<tr><td></td><td><span class="errormsg">' . t('The short description is empty.') . '</span></td></tr>';
 $desc_empty_message = '<span class="errormsg">' . t('The description is empty.') . '</span>';
